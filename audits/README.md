...
### Planned siblings (per upstream module docstring)

The forwarded module declares itself *"Compatible with `first_principles_audit.py` and `study_extractor.py`"*. Those siblings are not yet written and ship in their own change events:
